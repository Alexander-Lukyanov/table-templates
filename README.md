...
<p align="justify">Кожна підпапка, асоційована з відповідним набором даних, в залежності від його специфіки, може містити в собі від одного до декількох десятків файлів Форматорів (один файл Форматору відповідає одній таблиці набору даних) XLSX формату. Наприклад, для такого набору даних, як <i>«Регламентовані звіти»</i> число файлів Форматорів буде відповідати числу систематично надаваних розпорядниками інформації стандартних форм звітності. Крім того, в кожній з підпапок розміщується спеціальний файл (також XLSX формату), що описує структуру всіх таблиць, властивих для того чи іншого набору даних, асоційованого з відповідною підпапкою.</p>
...
<p align="justify">На сьогоднішній момент всього вже підготовлено <b>27-м</b> таких підпапок в яких розміщується близько <b>63-х</b> файлів з безпосередніми Форматорами та <b>27-м</b> файлів зі структурами таблиць для відповідних наборів даних.</p>
