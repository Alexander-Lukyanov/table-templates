...
* Коли відкриється нове модальнє вікно слід спочатку відкоригувати назву файлу (видалити з його кінця текст: *«- копія»*), потім вибрати *«Мій диск» -> «Форматори»*, після цього відзначити галочкою пункт *«Копіювати коментарі»*, але категорично не відзначати пункт *«Надати доступ тим самим людям»* і, нарешті, натиснути кнопку *«ОК»*.
