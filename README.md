...
1. [<b>all-001</b> - Набір данних: «Довідник підприємств, установ (закладів) та організацій розпорядника інформації та підпорядкованих йому організацій»](#Набір-данних-all-001)<br>
2. [<b>all-002</b> - Набір данних: «Інформація про організаційну структуру розпорядника інформації»](#Набір-данних-all-002)<br>
3. [<b>all-010</b> - Набір данних: «Фінансова звітність суб’єктів господарювання державного сектору економіки»](#Набір-данних-all-010)<br>
4. [<b>all-011</b> - Набір данних: «Переліки регуляторних актів із зазначенням дати набрання чинності, строку проведення базового, повторного та періодичного їх відстеження»](#Набір-данних-all-011)<br>
5. [<b>mun-002</b> - Набір данних: «Перелік об’єктів комуна-льної власності»](#Набір-данних-mun-002)
