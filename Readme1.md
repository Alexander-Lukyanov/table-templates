...
* Відкрити загальнодоступну папку з вже наявними заготовками Форматорів перейшовши за посиланням: [«Заготовки Форматорів»](https://drive.google.com/drive/folders/1M8NGbIeR7qUuhJjCpiuVoTmlfYShES2b?usp=sharing).
...
* У лівому вертикальному меню свого Google диску клацнути мишкою на пункті *«Відкриті для мене»* знайти папку **Форматори»**, клацнути на ній правою кнопкою мишки та вибрати команду *«Додати до мого диску»*.
...
<p align="center"><b>Малюнок 1.</b> <i> Google диск розпорядника інформації після того, як він попередньо відкриє у себе в браузері загальнодоступну папку <b>«Форматори»</b></i></p>
