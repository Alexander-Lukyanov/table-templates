...
Імена та описи файлів всередині підпапки | <i>1. orgStructureFormatter</i> - Інформація про організаційну структуру розпорядника інформації<br><i>2. allStructure-002</i> - Описання структури для таблиці: orgStructure<br><i>===== <b>Додатково, для повної версії комплектації Форматорів передбачені</b> =====</i><br>Паспорт з метаданими для відповідного набору даних у вигляді файлу: <i>allPassport-002</i>,<br>а також паспорт ресурсу для цього набору у вигляді файлу: <i>orgStructureDescript</i>
