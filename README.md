# ФОРМАТОРИ
<p align="center"><b><i> Викладено на підставі [частини І](https://data.gov.ua/blog/proekt-rekomendatsi) і [частини ІІ](https://data.gov.ua/blog/proekt-rekomendatsii-2) рекомендацій щодо оприлюднення наборів відкритих даних органів місцевого самоврядування розроблених  ГО «Агенція журналістики даних» у партнерстві з проектом USAID / UK aid «Прозорість та підзвітність у державному управлінні та послугах» та Міністерством цифрової трансформації України</i></b></p>
