...
У загальній папці, де розміщуються всі папки, асоційовані з відповідними наборами даних, також розміщується спеціальний файл <b><i>«IdentificationData»</i></b>, призначений для введення в нього ідентифікаційних даних того розпорядника інформації, який в подальшому має намір користуватися Форматорами. Надалі за рахунок заповнення даного файлу відповідними відомостями буде забезпечуватися істотне зниження обсягу введення типових (властивих тільки для конкретного розпорядника) даних, а отже, і виключатися можливість помилок в цих даних.
