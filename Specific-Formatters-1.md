...
#### 4.2. Особливості реалізації пакетного (багаторазового) завантаження на портал spending.gov.ua «Результуючих таблиць» Форматорів, що стосуються укладених договорів та інших документів, які регламентують господарські відносини

<p align="justify">З метою реалізації пакетного (багаторазового) завантаження на портал <i>spending.gov.ua «Результуючих таблиць»</i> Форматорів, котрі стосуються укладених договорів та інших регламентуючих документів, кожному розпоряднику інформації слід виконати ряд наступних дій:</p>
<p align="justify"><b>1.</b> Перейти на лист, який має в своєму імені слово <i>«Spending»</i> і зберегти його на локальному комп'ютері за допомогою команди: <i>«Файл» -> «Завантажити як» -> «Значення, розділені комами (.csv поточний лист)»</i>.</p>
<p align="justify"><b>2.</b> У службовому кабінеті розпорядника інформації порталу <i>spending.gov.ua</i>, на сторінці договорів або будь-яких інших необхідних документів, що регламентують господарські відносини, натиснути кнопку <i>«СКАЧАТИ»</i>, після чого відкриється сторінка <i>«Завантаження відповідних документів»</i>.</p>
<p align="justify"><b>3.</b> На сторінці <i>«Завантаження відповідних документів»</i> необхідно натиснути кнопку <i>«ВИБРАТИ»</i> і вибрати тільки що збережений (на першому етапі) CSV файл для його завантаження на портал <i>spending.gov.ua</i>. Результатом завантаження цього CSV файлу є завантаження на портал договорів або будь-яких інших регламентуючих документів з відповідними полями.
