...
<p align="justify">• Відкрити загальнодоступну папку з вже наявними заготовками Форматорів перейшовши за посиланням: [«Заготовки Форматорів»](https://drive.google.com/drive/folders/1M8NGbIeR7qUuhJjCpiuVoTmlfYShES2b?usp=sharing).</p>
<p align="justify">• Зайти в новій вкладці свого браузера (браузера, де був зареєстрований аккаунт Google) на домашню сторінку [Google](https://www.google.com.ua/), відкрити в ній меню з Додатками та зайти в цьому меню на свій Google диск.</p>
<p align="justify">• У лівому вертикальному меню свого Google диску клацнути мишкою на пункті <i>«Відкриті для мене»</i>, знайти папку <b>«Форматори»</b>, клацнути на ній правою кнопкою мишки та вибрати команду <i>«Додати до мого диску»</i>.</p>
