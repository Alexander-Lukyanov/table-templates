...
<p align="justify">У кожній підпапки з Форматорами обов'язково має бути розміщений спеціальний XLSX файл, що служить для опису табличних структур ресурсів конкретного набору даних, асоційованого з відповідною підпапкою, де він знаходиться. Цей спеціальний файл завжди містить у своєму найменуванні слово <i>«Structure»</i> та <i>код набору даних (назву підпапки)</i> для якого він був сформований. Наприклад, файл <i>«allStructure-005»</i> описує табличні структури ресурсів для такого набору даних, як <i>«Звіти, в тому числі щодо задоволення запитів на інформацію»</i> з кодом <b>«all-005»</b>.</p>
