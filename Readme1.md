...
<p align="justify">Опис специфічних Форматорів, розроблених для 2-х перших наборів даних наведений за посиланням: Особливості Форматорів, розроблених з урахуванням публікації їх «Результуючих таблиць» на Єдиному порталі використання публічних коштів (spending.gov.ua).</p>
