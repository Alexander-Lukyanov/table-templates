...
<p align="justify"><b>Примітка:</b> Як правило, в усі Форматори з файлу <i>«IdentificationData.xls»</i> в обов'язковому порядку автоматично вносяться лише дані <i>за кодом ЄДРПОУ</i> та <i>за кодом КОАТУУ</i>. Внесення всіх інших даних з файлу <i>«IdentificationData.xls»</i> зазвичай визначається виходячи з вимог щодо змісту відповідних Форматорів.</p>
