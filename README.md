...
| Посилання на файли форматорів та структур | Короткий опис таблиць форматорів або файлів структур |
| ------ | ------ |
| [planFormatter.xls](https://docs.google.com/spreadsheets/d/1rFPMMuKfPldCuRTfXnyGt6_8EC3N40KrZQB1zAKfNs4/edit?usp=sharing) | Основні відомості щодо планів діяльності з підготовки проектів регуляторних актів<br>із зазначенням видів і назв проектів, цілей їх прийняття, строків підготовки проектів, найменування органів та підрозділів, відповідальних за розроблення проектів<br>регуляторних актів, дату їх внесення на розгляд регуляторного органу та посилання на місце оприлюднення |
