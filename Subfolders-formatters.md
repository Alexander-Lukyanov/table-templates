...
Імена та описи<br>файлів всередині<br>підпапки | <b>Для повної версії комплектації Форматорів в цьому наборі передбачені:</b><br>Паспорт з метаданими для відповідного набору даних у вигляді файлу: <i>allPassport-008</i>, а також паспортів ресурсів для цього набору у вигляді: файлу: <i>statReportDescript</i> - «Архів статистичної звітності установи» та файлу <i>inventoryListDescript</i> - «Інвентарні списки основних засобів, що значаться на балансі установи»
Рекомендації щодо оприлюднення набору даних | [Рекомендації щодо оприлюднення 12-ти наборів даних, що розміщені на Єдиному державному портал відкритих даних](https://data.gov.ua/uploads/files/2019-03-26-152803.323178835cookbook.pdf)
