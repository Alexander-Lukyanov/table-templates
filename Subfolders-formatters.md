...
Імена та описи<br>файлів всередині<br>підпапки | <b>За умови повної комплектації Форматорів в цьому наборі передбачені такі ресурси:</b><br>Паспорт з метаданими для відповідного набору даних у вигляді файлу: <i>munPassport-056</i>,<br>а також паспорт щодо ресурсу для цього набору у вигляді файлу:<br><i>materialsDescript</i> - «Перелік графічних матеріалів з відомостями щодо містобудівного кадастру і геопросторових даних»
Рекомендації<br>щодо оприлюднення<br>набору даних | [Рекомендації щодо оприлюднення даних містобудівного кадастру, у тому числі геопросторових даних](https://docs.google.com/document/d/1KtVJaEH9iwRI8d4eIcBmUuiMErYKF9RYlmuKeuejDFc/edit#)
