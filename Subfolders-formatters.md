...
Імена та описи файлів всередині підпапки | <i>1. organizationsFormatter</i> - Довідник підпорядкованих підприємств, установ (закладів) та організацій розпорядника, що, як правило, є окремими юридичними особами<br><i>2. organizationalUnitsFormatter</i> - Довідник структурних підрозділів юридичної особи розпорядника<br><i>3. postsFormatter</i> - Довідник посадових осіб/працівників юридичної особи розпорядника<br><i>4. allStructure-001</i> - Описання структур для таблиць organizations, organizationalUnits та posts<br><i>=====Додатково, для повної версії комплектації Форматорів передбачені=====</i><br>Паспорт з метаданими для відповідного набору даних у вигляді файлу: <i>allPassport-001</i>, а також паспорта ресурсів для цього набору у вигляді файлів: <i>organizationsDescript, organizationalUnitsDescript</i> та <i>postsDescript</i>
