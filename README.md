...
<p align="justify">Кожна підпапка, асоційована з відповідним набором даних, в залежності від його специфіки, може містити в собі від одного до декількох десятків файлів Форматорів XLSX формату (один файл Форматору відповідає одній таблиці набору даних). Наприклад, для такого набору даних, як <i>«Регламентовані звіти»</i> число файлів Форматорів буде відповідати числу систематично надаваних розпорядниками інформації стандартних форм звітності. Крім того, в кожній з підпапок розміщується спеціальний файл (також XLSX формату), що описує структуру всіх таблиць, властивих для того чи іншого набору даних, асоційованого з відповідною підпапкою.</p>
<p align="justify">Також, в основній папці <i>«Форматори»</i> розміщується спеціальний файл <b><i>«IdentificationData»</i></b>, призначений для введення в нього ідентифікаційних даних того розпорядника інформації, який в подальшому має намір користуватися Форматорами. Надалі за рахунок заповнення даного файлу відповідними відомостями буде забезпечуватися істотне зниження обсягу введення типових (властивих тільки для конкретного розпорядника) даних, а отже, і виключатися можливість помилок в цих даних.</p>
...
* Відкрити загальнодоступну папку з архівом усіх заготовок Форматорів перейшовши за посиланням: [«Архів Форматорів»](https://drive.google.com/drive/folders/1VkrfoF5ybjc-g_dk9D-vOS2f3BcuW3PB?usp=sharing).
...
<p align="justify">На сьогоднішній момент всього вже підготовлено <b>27</b> таких підпапок в яких розміщується <b>61</b> файл з безпосередніми Форматорами та <b>27</b> файлів, що описують табличну структуру ресурсів відповідних наборів даних.</p>
...
<p align="justify">У кожній підпапки з Форматорами обов'язково має бути розміщений один спеціальний XLSX файл, що служить для опису табличних структур ресурсів конкретного набору даних, асоційованого з відповідною підпапкою, де він знаходиться. Цей спеціальний файл завжди містить у своєму найменуванні слово <i>«Structure»</i> та <i>код набору даних (назву підпапки)</i> для якого він був сформований. Наприклад, файл <i>«allStructure-005»</i> описує табличні структури ресурсів для такого набору даних, як <i>«Звіти, в тому числі щодо задоволення запитів на інформацію»<i>.</p>
<p align="justify">Всі файли з табличними структурами ресурсів розпорядники інформації в обов'язковому порядку повинні публікувати на відповідних порталах відкритих даних разом з пере конвертованими в CSV (XLSX) формати файлами з <i>«Результуючими таблицями»</i> Форматорів. Це, в свою чергу, дозволить об'єднувати набори даних за різними критеріями, а отже і активізувати розробку нових найрізноманітніших програмних сервісів на основі відкритих даних в сфері аналітики, отримання довідкової інформації та надання електронних послуг.</p>
