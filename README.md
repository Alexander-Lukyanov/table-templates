...
<p align="justify"><b><u>Примітка: </u></b> Більш детальну інформацію про алгоритм збереження форматорів на особистих Google дисках розпорядників інформації, а також опис основних принципів оприлюднення відкритих даних Ви можете знайти в «Пам'ятці щодо оприлюднення відкритих даних на Єдиному державному порталі та на інших відповідних порталах органів влади центрального і регіонального рівня» за адресою: http://bit.ly/2ES55Y4.</p>
