...
<p align="justify">Опис специфічних Форматорів, розроблених для 2-х перших наборів даних наведений за посиланням: <a href="https://github.com/Alexander-Lukyanov/table-templates/blob/master/Specific%20Formatters.md" target="_blank">Особливості Форматорів, розроблених з урахуванням публікації їх &laquo;Результуючих таблиць&raquo; на Єдиному порталі використання публічних коштів (spending.gov.ua)</a>.</p>
