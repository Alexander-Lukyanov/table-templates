...
Імена та описи<br>файлів всередині<br>підпапки | <b>За умови повної комплектації Форматорів в цьому наборі передбачені такі ресурси:</b><br>Паспорт з метаданими для відповідного набору даних у вигляді файлу: <i>munPassport-043</i>, а також паспорта ресурсу для цього набору у вигляді файлу:<br><i>handlingInfoDescript</i> - «Дані про надані адміністративні послуги»
