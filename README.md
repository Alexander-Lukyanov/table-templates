...
<p align="justify"><b>Примітка:</b> При подальшому заповненні того чи іншого файлу Форматору на комірках його листа з <i>«Результуючою таблицею»</i>, в місці де передбачається автоматичне введення даних з файлу <i>«IdentificationData.xls»</i> спочатку завжди виникають повідомлення <b>«#REF!»</b>. Тому, розпорядникам інформації в обов'язковому порядку слід позбутися цього повідомлення. Це можна зробити просто клацнувши мишкою на будь-який комірки з повідомленням та натиснувши в ній на синю кнопку <i>«Дозволити доступ»</i>.</p>
...
<p align="center"><b>Малюнок 3.</b> <i>Остаточне прив'язування файлу Форматору до файлу <b>«IdentificationData.xls»</b></i></p>
