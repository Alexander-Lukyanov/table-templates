...
<p align="center"><b>Малюнок 1.</b> <i>Приклад заповнення файлу одного з Форматорів</i></p>
...
2. Пере зберегти, імпортований в *Excel* або відкритий в *Libre Office Calc*, CSV файл в XLSX форматі.
