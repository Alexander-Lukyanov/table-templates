...
* Перейти в цій папці на необхідну папку зі стандартним або з повним комплектом архівів, після чого вибрати підпапку з тієї чи іншої категорією наборів даних і, вже в ній знайти і завантажити собі на локальний комп'ютер архів з потрібним набором даних (наприклад, файл з ім'ям *mun-042.zip* який відповідає набору даних *«Адресный реестр»*). До речі, для того, щоб можна було легко знайти аврхів з Форматорами потрібного набору, в кожній з 12-ти підпапок, котрі об'єднують набори по тим чи іншим категоріям, передбачений PDF файл з відповідною розшифровкою
