...
<p align="justify">Після виконання всіх вище перерахованих дій ви, як розпорядник інформації, на своєму особистому Google диску отримаєте у відповідних підпапках папки <i>«Форматори»</i> всі, розроблені на даний момент заготовки файлів Форматорів, котрі будуть придатні для свого подальшого заповнення.
