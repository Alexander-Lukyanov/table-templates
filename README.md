...
<p align="justify">Після виконання всіх вище перерахованих дій розпорядники інформації у відповідних підпапках всередині папки <i>«Форматори»</i> на своєму особистому Google диску отримають всі, розроблені на даний момент заготовки файлів Форматорів, котрі будуть придатні для їх подальшого заповнення.
