...
<p align="justify">Після того, як розпорядники інформації скопіюють загальнодоступну папку з заготовками Форматорів на свої індивідуальні Google диски, кожна така копія папки під назвою «Форматори» буде містити ряд підпапок з файлами всередині них. Розшифровки імен та змістів цих файлів та підпапок наводяться у вигляді <a href="https://github.com/Alexander-Lukyanov/table-templates/blob/master/Readme1.md" target="_blank">відповідної таблиці</a> на окремій сторінці.</p>
<p align="justify">На сьогоднішній момент всього вже підготовлено 27-м таких підпапок в яких розміщується близько 63-х XLS файлів з безпосередніми Форматорами та 27-м CSV файлів зі структурами таблиць для відповідних наборів даних.</p>
