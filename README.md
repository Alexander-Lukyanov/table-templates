...
<p align="justify">Після того, як розпорядники інформації на свої індивідуальні Google диски з загальнодоступного архіву скопіюють папку під назвою <b>«Форматори»</b>, вона буде містити ряд відповідних підпапок з файлами зоготовок Форматорів всередині них. Розшифровки імен та змістів цих підпапок і файлів в їх складі наводяться у вигляді <a href="https://github.com/Alexander-Lukyanov/table-templates/blob/master/Subfolders-formatters.md" target="_blank">відповідної таблиці</a> на окремій сторінці.</p>
<p align="justify">На сьогоднішній момент всього вже підготовлено <b>27-м</b> таких підпапок в яких розміщується близько <b>63-х</b> XLS файлів з безпосередніми Форматорами та <b>27-м</b> CSV файлів зі структурами таблиць для відповідних наборів даних.</p>

---

### 2.4. Заповнення файлу «IdentificationData.xls» ідентифікаційними даними розпорядника інформації

<p align="justify">Попередньо, перед тим як приступати до безпосереднього заповнення Форматорів, кожному розпоряднику інформації слід в файлі <b><i>«IdentificationData.xls»</i></b> вказати свої ідентифікаційні дані. Це повинно забезпечити для цих розпорядників істотне зниження обсягу введення типових (властивих тільки їм) даних, а отже, і виключити можливість помилок в таких даних при подальшому заповненні Форматорів.</p>
...
* Пройти по посиланню [***«IdentificationData.xls»***](https://docs.google.com/spreadsheets/d/1-ddExoXWm_hgHshqGqV1NeWW2pwInN2-Dn85K2wTzP8/edit?usp=sharing), відкривши таким чином загальнодоступний файл з відповідною заготовкою (шаблоном) для введення ідентифікаційних даних в програмі *Google sheets*.
...
* Після цього у вашому браузері відкриється нова вкладка з уже збереженої на вашому Google диску заготовкою файлу *«IdentificationData.xls»*, яку ви можете починати заповнювати.
...
<p align="justify"><b>Примітка:</b> З метою автоматичного внесення ідентифікаційних даних з файлу <i>«IdentificationData.xls»</i> в усі відповідні файли Форматорів, розпорядникам інформації потрібно спочатку зв'язати ці файли між собою. Для цього в кожному файлі Форматорі, на окремому листку <i>«Прив'язка до даних розпорядника»</i> в комірки <b>B1</b> розпорядникам інформації слід вказати URL адресу свого індивідуального файлу <i>«IdentificationData.xls»</i>. Цю URL адресу можна скопіювати у верхньому адресному рядку браузера після відкриття файлу </i>«IdentificationData.xls»</i> в програмі <i>Google sheets</i> на індивідуальному Google диску конкретного розпорядника інформації в відповідний папці <i>«Форматори»</i>.</p>
<p align="justify"><b>Примітка:</b> Як правило, в усі Форматори з файлу <i>«IdentificationData.xls»</i> в обов'язковому порядку автоматично вносяться лише дані <i>за кодом ЄДРПОУ, за кодом КОАТУУ</i>, а також дані <i>по типу установи розпорядника даних</i>. Внесення всіх інших даних з файлу <i>«IdentificationData.xls»</i> зазвичай визначається виходячи з вимог щодо змісту відповідних Форматорів.</p>
...
* **Прив'язка до даних розпорядника** - цей лист призначений для зв'язування файлу *«IdentificationData.xls»*, де повинні знаходитися ідентифікаційні дані розпорядників інформації з файлами Форматорів, куди ці дані мають бути автоматично внесені. Даний лист існує не в кожному файлі Форматорі, але при його наявності розпорядникам інформації необхідно буде лише ввести в комірку **B1** URL адресу свого індивідуального файлу *«IdentificationData.xls»*. Цю URL адресу можна скопіювати в верхньому адресному рядку браузера після відкриття файлу *"IdentificationData.xls»*в програмі *oogle sheets* на індивідуальному Google диску конкретного розпорядника інформації в відповідний папці *«Форматори»*.
