...
* [2.4. Заповнення файлу «IdentificationData» ідентифікаційними даними розпорядника інформації](#24-Заповнення-файлу-IdentificationDataxls-ідентифікаційними-даними-розпорядника-інформації)
