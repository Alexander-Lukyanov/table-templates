...
* Перейти в цій папці на необхідну папку зі стандартним або з повним комплектом архівів.
* Вибрати підпапку з тієї чи іншої категорією наборів даних і в ній знайти та завантажити собі на локальний комп'ютер архів з потрібним набором даних (наприклад, файл з ім'ям *mun-042.zip* який відповідає набору даних *«Адресный реестр»*).

<p align="justify"><b>Примітка:</b>Для того, щоб можна було легко знайти аврхів з Форматорами потрібного набору, в кожній з 12-ти підпапок, котрі об'єднують набори по тим чи іншим категоріям, передбачений PDF файл з відповідною розшифровкою.</p>
...
<p align="justify">Для завантаження потрібних архівів, розпорядникам інформації необхідно, перш за все, зорієнтуватися, в яких архівах (папках) лежать шаблони форматорів для необхідних їм наборів даних. З цією метою, як уже було сказано вище, в кожній з 12-ти підпапок, що об'єднують архіви з Форматорами по категоріях, передбачені PDF файли з відповідними розшифровками. Поряд з цим, на окремій сторінці даної інструкції наводяться <a href="https://github.com/Alexander-Lukyanov/table-templates/blob/master/Subfolders-formatters.md" target="_blank">«Розшифровки змісту загальнодоступних архівів (папок) з шаблонами Форматорів, притаманними тому чи іншому набору даних»</a> які містять імена та призначення всіх файлів, включених, як в стандартний, так і в повний набір Форматорів.</p>
<p align="justify">Склад архівів Форматорів, підготовлених відповідно до остаточною версією рекомендацій щодо оприлюднення наборів даних включає в себе:</p>

* **Для повного комплекту форматорів** - ***74*** файла з архівами (папки з 74-ма відповідними наборами даних) в яких розміщується ***102*** файлів з безпосередніми Форматорами, ***59*** файлів, що описують табличну структуру ресурсів відповідних наборів даних, ***74*** файлів паспортів для відповідних наборів даних та ***135*** файла паспорта для ресурсів цих наборів даних.
* **Для стандартного комплекту форматорів** - ***58*** архівів (папок з 58-ю відповідними наборами даних) в яких розміщується ***102*** файлів з безпосередніми Форматорами та ***59*** файлів, що описують табличну структуру ресурсів відповідних наборів даних.
