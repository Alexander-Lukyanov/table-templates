...
<p align="justify">Що ж стосується 3-го (останнього) набору даних, то тут потрібно просто мати на увазі, що для коректного заповнення такого файлу Форматору в цьому наборі, як <i>«accessibilityToolsFormatter.xls»</i> слід використовувати «Короткий довідник державних норм і стандартів щодо забезпечення зовнішньої доступності інфраструктурних об'єктів для маломобільних груп населення». Цей довідник, зокрема, полегшить оцінювання відповідності обстежуваного засобу доступності (елементу інфраструктурного об'єкта) існуючим державним нормативам.
