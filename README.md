...
* ППерейти в цій папці на необхідну папку зі стандартним або з повним комплектом архівів та завантажити в ній собі на локальний комп'ютер архів з потрібним набором даних (наприклад, файл з ім'ям *mun-042.zip* який відповідає набору даних *«Адресный реестр»*)
...
<p align="center"><b>Увага:</b> наступні дві дії достатньо виконати лише один раз при завантаженні першого архіву. Коли проводиться завантаження наступних архівів наборів даних, ці дві дії можна пропустити</p>
